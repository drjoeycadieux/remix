                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 w-full">
                    ...
                    <div className="md:col-span-1">
                        <div className="flex items-center space-x-2 mb-4">
                            ...
                            <span className="text-xl font-bold text-white">CloudFoundry</span>
                        </div>
                        <p className="text-gray-400 text-sm leading-relaxed">
                            Modern software foundations in the cloud. Building scalable, reliable applications with cutting-edge technology.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li><a href="/" className="text-gray-400 hover:text-white transition-colors duration-200 text-sm">Overview</a></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li><a href="/quickstart" className="text-gray-400 hover:text-white transition-colors duration-200 text-sm">Quick Start</a></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li><a href="/about" className="text-gray-400 hover:text-white transition-colors duration-200 text-sm">About</a></li>
                ...
                <div className="mx-auto max-w-7xl px-6 py-6 md:flex md:items-center md:justify-between lg:px-8">
                    <div className="flex flex-col md:flex-row md:items-center md:space-x-8">
                        <p className="text-sm text-gray-400">
                            © 2025 CloudFoundry. All rights reserved.
                        </p>
                    ...
                    <div className="flex items-center space-x-2 mt-4 md:mt-0">
                        ...
                        <span className="text-xs text-blue-400 font-medium">Remix.run</span>
                        <span className="text-xs text-gray-500">•</span>
                        <span className="text-xs text-gray-500">Powered by</span>
                        <span className="text-xs text-cyan-400 font-medium">Tailwind CSS</span>
                    </div>
                </div>
            </div>
        </footer>
